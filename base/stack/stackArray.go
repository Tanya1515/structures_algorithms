...
// Сложность вставки элемента: O(1), поскольку элемент просто добавляется в конец массива

// Сложность удаления элемента: O(1), элемент просто удаляется из конца массива 
