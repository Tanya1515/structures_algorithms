...
// Stack, где N - количество элементов в stack: 

// Сложность вставки элемента: O(1), поскольку элемент просто добавляется на верхушку стека. 

// Сложность удаления элемента: O(1), поскольку просто удаляется элемент с верхушки стека. 
