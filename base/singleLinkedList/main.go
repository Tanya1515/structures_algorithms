...
//OK
// Односвязный список, где N - количество элементов в односвязном списке: 

// Сложность вставки элемента: O(N), поскольку элемент добавляется в конец

// Сложность удаления элемента: O(N), поскольку необходимо дойти до 
// местоположения вставки (индекса)
